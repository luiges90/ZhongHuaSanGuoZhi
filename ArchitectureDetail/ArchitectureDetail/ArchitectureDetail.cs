namespace ArchitectureDetail
{
    ...
    public class ArchitectureDetail
    {
        ...
        internal void Draw(SpriteBatch spriteBatch)
        {
            if (this.ShowingArchitecture != null)
            {
                ...
                {                  
                    if (Switch21 == "on")
                    {
                        spriteBatch.Draw(this.InformationButtonTexture, this.InformationButtonDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18f);
                        spriteBatch.Draw(this.InformationPressedTexture, this.InformationPressedDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18f);
                        if (InformationButton == true)
                        {
                            spriteBatch.Draw(this.InformationMask1, this.InformationBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.192f);
                            spriteBatch.Draw(this.InformationMask2, this.InformationBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.199f);
                            spriteBatch.Draw(this.InformationBackground, this.InformationBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.2f);
                            foreach (LabelText text in this.ArchitectureInInformationTexts)
                            {
                                text.Label.Draw(spriteBatch, 0.194f);
                                text.Text.Draw(spriteBatch, 0.194f);
                            }
                            if (Switch26 == "on")
                            {
                                try
                                {
                                    ...
                                    {
                                        spriteBatch.Draw(this.PictureforAKind, this.PictureforAKindDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.197f);
                                    }
                                    if (PictureShowforAID == "on")
                                    {
                                        spriteBatch.Draw(this.PictureforAID, this.PictureforAIDDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1975f);
                                    }
                                }
                                catch { }
                            }
                            if (Switch22 == "on")
                            {
                                try
                                {
                                    spriteBatch.Draw(this.IntegrationBarTexture, this.IntegrationBar1DisplayPosition, this.Integration1DisplayPosition, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.196f);
                                    spriteBatch.Draw(this.DominationBarTexture, this.DominationBar1DisplayPosition, this.Domination1DisplayPosition, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.196f);
                                    spriteBatch.Draw(this.EnduranceBarTexture, this.EnduranceBar1DisplayPosition, this.Endurance1DisplayPosition, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.196f);
                                    spriteBatch.Draw(this.AgricultureBarTexture, this.AgricultureBar1DisplayPosition, this.Agriculture1DisplayPosition, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.196f);
                                    spriteBatch.Draw(this.CommerceBarTexture, this.CommerceBar1DisplayPosition, this.Commerce1DisplayPosition, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.196f);
                                    spriteBatch.Draw(this.TechnologyBarTexture, this.TechnologyBar1DisplayPosition, this.Technology1DisplayPosition, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.196f);
                                    spriteBatch.Draw(this.MoraleBarTexture, this.MoraleBar1DisplayPosition, this.Morale1DisplayPosition, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.196f);
                                    spriteBatch.Draw(this.FacilityCountBarTexture, this.FacilityCountBar1DisplayPosition, this.FacilityCount1DisplayPosition, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.196f);
                                }
                                catch { }
                            }
                            if (Switch23 == "on" && TheCharacteristicCount >0)
                            {
                                spriteBatch.Draw(this.CharacteristicShowMask, this.CharacteristicShowBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.185f);                                
                                try
                                {
                                    for (int c = 1; c <= TheMaxShowCharacteristicCount; c++)
                                    {
                                        spriteBatch.Draw(this.TheCharacteristicShowMask, this.TheCharacteristicShowDisplayPosition(c), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.186f);                               
                                        spriteBatch.Draw(this.TheCharacteristicShow(c), this.TheCharacteristicShowDisplayPosition(c), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.188f);
                                    }
                                    if (ShowNullCharacteristicPicture == "on")
                                    {
                                        for (int c = 1; c <= TheMaxShowCharacteristicCount; c++)
                                        {
                                            spriteBatch.Draw(this.TheCharacteristicShowBackground, this.TheCharacteristicShowDisplayPosition(c), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.188f);
                                        }
                                    }
                                }
                                catch { }
                                spriteBatch.Draw(this.CharacteristicShowBackground, this.CharacteristicShowBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.19f); 
                            }
                            if (Switch24 == "on")
                            {
                                this.TheCharacteristic1Text.Draw(spriteBatch, 0.194f);
                            }
                            if (Switch25 == "on")
                            {
                    ...
                    if (Switch41 == "on")
                    {
                        spriteBatch.Draw(this.FacilityButtonTexture, this.FacilityButtonDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18f);
                        spriteBatch.Draw(this.FacilityPressedTexture, this.FacilityPressedDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18f);
                        if (FacilityButton == true)
                        {
                            spriteBatch.Draw(this.FacilityMask1, this.FacilityBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.192f);
                            spriteBatch.Draw(this.FacilityMask2, this.FacilityBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.199f);
                            spriteBatch.Draw(this.FacilityBackground, this.FacilityBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.2f);
                            if (Switch47 == "on")
                            {
                                this.TheFacility3Text.Draw(spriteBatch, 0.198f);
                            }
                            if (Switch42 == "on")
                            {
                            ...
                            {
                                spriteBatch.Draw(this.PageForFacilityMask, this.PageForFacilityBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.194f);
                                spriteBatch.Draw(this.PageForFacilityBackground, this.PageForFacilityBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.196f);
                            }
                            else 
                            {
                                try
                                {
                                    for (int i = 1; i <= 30; i++)
                                    {
                                        ...
                                        {
                                            spriteBatch.Draw(this.FacilityforPageButtonTexture(i), this.TheFacilityforPageButtonDisplayPosition(i), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.181f);
                                            spriteBatch.Draw(this.FacilityforPagePressedTexture(i), this.TheFacilityforPagePressedDisplayPosition(i), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.181f);
                                            spriteBatch.Draw(this.ThePageForFacilityMask(i), this.ThePageForFacilityBackgroundDisplayPosition(i), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.193f);
                                            spriteBatch.Draw(this.ThePageForFacilityBackground(i), this.ThePageForFacilityBackgroundDisplayPosition(i), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.197f);
                                        }
                                    }
                                }
                                catch { }
                                try
                                {
                                    ...
                                    {
                                        spriteBatch.Draw(this.TheFacilityPictureA(i), this.TheFacilityAShowDisplayPosition(i), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.196f);
                                        if (Switch45 == "on")
                                        {
                                            spriteBatch.Draw(this.TheFacilityPictureB(i), this.TheFacilityBShowDisplayPosition(i), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.195f);
                                        }
                                        if (Switch46 == "on")
                                        {
                                            spriteBatch.Draw(this.TheFacilityTextPicture(i), this.TheFacilityTextShowDisplayPosition(i), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.194f);
                                        }
                                    }
                                    if (HasBuildingFacility == true)
                                    {
                                        spriteBatch.Draw(this.TheBuildingFacilityPictureA, this.TheBuildingFacilityPictureADisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.196f);
                                        if (Switch45 == "on")
                                        {
                                            spriteBatch.Draw(this.TheBuildingFacilityPictureB, this.TheBuildingFacilityPictureBDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.195f);
                                        }
                                        if (Switch46 == "on")
                                        {
                                            spriteBatch.Draw(this.TheBuildingFacilityTextPicture, this.TheBuildingFacilityTextDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.194f);
                                        }
                                    }                                    
                                }
                                catch { }
                                spriteBatch.Draw(this.FacilityDescriptionTextMask, this.FacilityDescriptionTextBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.185f);
                                spriteBatch.Draw(this.FacilityDescriptionTextBackground, this.FacilityDescriptionTextBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.19f);
                                this.FacilityDescriptionText.Draw(spriteBatch, 0.186f);                                   
        ...
        private void screen_OnMouseLeftDown(Point position)
        {
            ...
            if (Switch1 == "on")
            {
                ...
                if (InformationButton == false && StaticMethods.PointInRectangle(position, this.InformationButtonDisplayPosition))
                {
                    if (Switch3 == "on")
                    {
                        this.screen.PlayNormalSound("GameComponents/ArchitectureDetail/Data/Sound/Open.wav");
                    }
                ...
                if (FacilityButton == true)
                {
                    ...
                    if (PageForFacilityPositionCount == "on")
                    {
                        if (FacilityforPage1Button == false && StaticMethods.PointInRectangle(position, this.TheFacilityforPageButtonDisplayPosition(1)))
                        {
                            if (Switch3 == "on")
                            {
                                this.screen.PlayNormalSound("GameComponents/ArchitectureDetail/Data/Sound/Select.wav");
                            }
        ...
        private void screen_OnMouseRightUp(Point position)
        {
            if (Switch3 == "on")
            {
                this.screen.PlayNormalSound("GameComponents/ArchitectureDetail/Data/Sound/Close.wav");
            }
