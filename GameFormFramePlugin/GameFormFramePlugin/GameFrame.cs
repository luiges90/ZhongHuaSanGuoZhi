namespace GameFormFramePlugin
{
    ...
    internal class GameFrame
    {
        ...
        internal void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(this.TopLeftTexture, this.TopLeftRectangle, sourceRectangle, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.4f);
            spriteBatch.Draw(this.TopRightTexture, this.TopRightRectangle, sourceRectangle, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.4f);
            spriteBatch.Draw(this.BottomLeftTexture, this.BottomLeftRectangle, sourceRectangle, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.4f);
            spriteBatch.Draw(this.BottomRightTexture, this.BottomRightRectangle, sourceRectangle, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.4f);
