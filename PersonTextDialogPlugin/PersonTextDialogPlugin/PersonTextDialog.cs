namespace PersonTextDialogPlugin
{
    ...
    internal class PersonTextDialog
    {
        ...
        internal IPersonTextDialog iPersonTextDialog;
        ...
        internal void SetGameObjectBranch(Person person, GameObject gameObject, string branchName)
        {
            ...
            {
                this.DisplayQueue.Enqueue(new GameObjectAndBranchName(person, gameObject, this.BuildingRichText.Texts, branchName, this.iConfirmationDialog, this.YesFunction, this.NoFunction));
                this.YesFunction = null;
                this.NoFunction = null;
            }
            else
            {
                this.DisplayQueue.Enqueue(new GameObjectAndBranchName(person, gameObject, this.BuildingRichText.Texts, branchName, null, null, null));
            }
            ...
            set
            {
                if (this.isShowing != value && GlobalVariables.DialogShowTime > 0)
                {
                    ...
                    if (value)
                    {
                        ...
                        this.screen.PushUndoneWork(new UndoneWorkItem(UndoneWorkKind.Dialog, DialogKind.PersonText));
