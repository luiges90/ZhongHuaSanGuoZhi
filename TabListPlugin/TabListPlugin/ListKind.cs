namespace TabListPlugin
{
    ...
    public class ListKind
    {
        ...
        internal void AddCheckBoxColumn()
        {
            ...
            item.ID = 0;
            item.Name = this.tabList.checkboxName;
            item.IsNumber = false;
            item.SmallToBig = false;
            item.DisplayName = this.tabList.checkboxDisplayName;
            item.MinWidth = this.tabList.checkboxWidth;
            item.Editable = true;
            item.ColumnTextList = new FreeTextList();
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            {
                nullable = null;
                spriteBatch.Draw(this.tabList.focusTrackTexture, new Microsoft.Xna.Framework.Rectangle(this.tabList.VisibleLowerClient.Left, this.tabList.Focused, this.tabList.VisibleLowerClient.Width - 1, 1), nullable, Microsoft.Xna.Framework.Graphics.Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.3498f);
                nullable = null;
                spriteBatch.Draw(this.tabList.focusTrackTexture, new Microsoft.Xna.Framework.Rectangle(this.tabList.VisibleLowerClient.Left, this.tabList.Focused, 1, this.tabList.rowHeight), nullable, Microsoft.Xna.Framework.Graphics.Color.White  , 0f, Vector2.Zero, SpriteEffects.None, 0.3498f);
                nullable = null;
                spriteBatch.Draw(this.tabList.focusTrackTexture, new Microsoft.Xna.Framework.Rectangle(this.tabList.VisibleLowerClient.Left, (this.tabList.Focused + this.tabList.rowHeight) - 1, this.tabList.VisibleLowerClient.Width - 1, 1), nullable, Microsoft.Xna.Framework.Graphics.Color.White  , 0f, Vector2.Zero, SpriteEffects.None, 0.3498f);
                nullable = null;
            ...
            {
                nullable = null;
                spriteBatch.Draw(this.tabList.scrolltrackTexture, this.LeftScrollTrack, nullable, Microsoft.Xna.Framework.Graphics.Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.3498f);
                nullable = null;
                spriteBatch.Draw(this.tabList.scrolltrackTexture, this.RightScrollTrack, nullable, Microsoft.Xna.Framework.Graphics.Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.3498f);
                nullable = null;
                spriteBatch.Draw(this.tabList.scrollbuttonTexture, this.VerticalScrollBar, nullable, Microsoft.Xna.Framework.Graphics.Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.3498f);
            }
            if (this.tabList.ShowHorizontalScrollBar)
            {
                nullable = null;
                spriteBatch.Draw(this.tabList.scrolltrackTexture, this.UpperScrollTrack, nullable, Microsoft.Xna.Framework.Graphics.Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.3498f);
                nullable = null;
                spriteBatch.Draw(this.tabList.scrolltrackTexture, this.LowerScrollTrack, nullable, Microsoft.Xna.Framework.Graphics.Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.3498f);
                spriteBatch.Draw(this.tabList.scrollbuttonTexture, this.HorizontalScrollBar, null, Microsoft.Xna.Framework.Graphics.Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.3498f);
            }
        }
        ...
        public void LoadFromXMLNode(XmlNode rootNode)
        {
            ...
            foreach (XmlNode node2 in node.ChildNodes)
            {
                ...
                Column item = new Column(this.tabList);
                item.ID = int.Parse(node2.Attributes.GetNamedItem("ID").Value);
            ...
            foreach (XmlNode node2 in node.ChildNodes)
            {
                Tab tab = new Tab(this.tabList, this);
                tab.ID = int.Parse(node2.Attributes.GetNamedItem("ID").Value);
                tab.Name = node2.Attributes.GetNamedItem("Name").Value;
                tab.DisplayName = node2.Attributes.GetNamedItem("DisplayName").Value;
                if (node2.Attributes.GetNamedItem("ListKind") != null)
                {
                    tab.ListKind = node2.Attributes.GetNamedItem("ListKind").Value;
                }
                if (node2.Attributes.GetNamedItem("ListMethod") != null)
                {
                    tab.ListMethod = node2.Attributes.GetNamedItem("ListMethod").Value;
                }
                tab.LoadColumnsFromString(node2.Attributes.GetNamedItem("Columns").Value);
                if (node2.Attributes.GetNamedItem("SortColumnID") != null)
                {
                    tab.SortColumnID = int.Parse(node2.Attributes.GetNamedItem("SortColumnID").Value);
                }
                if (node2.Attributes.GetNamedItem("SmallToBig") != null)
                {
                    tab.SmallToBig = bool.Parse(node2.Attributes.GetNamedItem("SmallToBig").Value);
                }
