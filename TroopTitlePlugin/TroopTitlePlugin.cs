    ...
    public class TroopTitlePlugin : GameObject, ITroopTitle, IBasePlugin, IPluginXML, IPluginGraphics
    {
        ...
        public void DrawTroop(SpriteBatch spriteBatch, object troop, bool playerControlling)
        {
            if (this.IsShowing)
            {
                ...
                {
                    this.troopTitle.ThePersonPicture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\PersonPicture\" + this.troopTitle.PersonID.ToString() + ".png");
                }
                if (troopTitle.Switch21 == "on" && this.troopTitle.HasFactionPicture == true)
                {
                    this.troopTitle.TheFactionPicture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\FactionPicture\" + this.troopTitle.FactionID.ToString() + ".png");
                }
                /*
                if (troopTitle.Switch31 == "on")
                {
                    this.troopTitle.TheTroopKindPicture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\TroopKind\" + this.troopTitle.TheTroopKind.ToString() + ".png");
                }
                 */ 
            }
        }
        ...
        public void LoadDataFromXMLDocument(string filename)
        {
            ...
            this.troopTitle.PictureNull = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\" + node.Attributes.GetNamedItem("PictureNull").Value);
            ...
            */
            ...
            this.troopTitle.TheBackground1 = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\" + node.Attributes.GetNamedItem("Background").Value);
            this.troopTitle.TheMask11 = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\" + node.Attributes.GetNamedItem("Mask1").Value);
            this.troopTitle.TheMask12 = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\" + node.Attributes.GetNamedItem("Mask2").Value);
            this.troopTitle.TheMask13 = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\" + node.Attributes.GetNamedItem("Mask3").Value);
            this.troopTitle.TheMask14 = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\" + node.Attributes.GetNamedItem("Mask4").Value);
            ...
            StaticMethods.LoadFontAndColorFromXMLNode(node, out font, out color);
            this.troopTitle.FactionName1Text = new FreeText(this.graphicsDevice, font, color);
            ...
            this.troopTitle.FactionName1Background = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\FactionPicture\" + node.Attributes.GetNamedItem("Background").Value);            
            node = nextSibling.ChildNodes.Item(27);
            this.troopTitle.FactionColor1Position = StaticMethods.LoadRectangleFromXMLNode(node);
            this.troopTitle.FactionColor1Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\FactionPicture\" + node.Attributes.GetNamedItem("ColorPicture").Value);
            this.troopTitle.FactionColor1Background = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\FactionPicture\" + node.Attributes.GetNamedItem("ColorBackground").Value);
            node = nextSibling.ChildNodes.Item(31);
            rectangle = StaticMethods.LoadRectangleFromXMLNode(node);
            StaticMethods.LoadFontAndColorFromXMLNode(node, out font, out color);
            this.troopTitle.TroopName1Text = new FreeText(this.graphicsDevice, font, color);
            ...
            this.troopTitle.TheTroopKind11Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\TroopKind\" + node.Attributes.GetNamedItem("TroopKind1").Value);
            this.troopTitle.TheTroopKind12Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\TroopKind\" + node.Attributes.GetNamedItem("TroopKind2").Value);
            this.troopTitle.TheTroopKind13Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\TroopKind\" + node.Attributes.GetNamedItem("TroopKind3").Value);
            this.troopTitle.TheTroopKind14Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\TroopKind\" + node.Attributes.GetNamedItem("TroopKind4").Value);
            this.troopTitle.TheTroopKind15Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\TroopKind\" + node.Attributes.GetNamedItem("TroopKind5").Value);
           
            node = nextSibling.ChildNodes.Item(37);
            rectangle = StaticMethods.LoadRectangleFromXMLNode(node);
            StaticMethods.LoadFontAndColorFromXMLNode(node, out font, out color);
            this.troopTitle.Thebingli1Text = new FreeText(this.graphicsDevice, font, color);
            ...
            this.troopTitle.TheActionDone1Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Done").Value);
            this.troopTitle.TheActionUndone1Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Undone").Value);
            this.troopTitle.TheActionAuto1Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Auto").Value);
            this.troopTitle.TheActionAutoDone1Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("AutoDone").Value);
            node = nextSibling.ChildNodes.Item(42);
            this.troopTitle.TheFoodIcon1Position = StaticMethods.LoadRectangleFromXMLNode(node);
            this.troopTitle.TheFoodNormal1Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Normal").Value);
            this.troopTitle.TheFoodShortage1Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Shortage").Value);            
            node = nextSibling.ChildNodes.Item(43);
            this.troopTitle.TheNoControl1Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("NoControl").Value);
            this.troopTitle.TheNoControlIcon1Position = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(44);
            this.troopTitle.TheStunt1Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Stunt").Value);
            this.troopTitle.TheStuntIcon1Position = StaticMethods.LoadRectangleFromXMLNode(node);

            node = nextSibling.ChildNodes.Item(46);
            this.troopTitle.Theshiqi1Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("FileName").Value);
            this.troopTitle.Theshiqi1Position = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(47);
            this.troopTitle.Thezhanyi1Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.troopTitle.TheBackground2 = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\" + node.Attributes.GetNamedItem("Background").Value);
            this.troopTitle.TheMask21 = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\" + node.Attributes.GetNamedItem("Mask1").Value);
            this.troopTitle.TheMask22 = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\" + node.Attributes.GetNamedItem("Mask2").Value);
            this.troopTitle.TheMask23 = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\" + node.Attributes.GetNamedItem("Mask3").Value);
            this.troopTitle.TheMask24 = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\" + node.Attributes.GetNamedItem("Mask4").Value);
            ...
            rectangle = StaticMethods.LoadRectangleFromXMLNode(node);
            StaticMethods.LoadFontAndColorFromXMLNode(node, out font, out color);
            this.troopTitle.FactionName2Text = new FreeText(this.graphicsDevice, font, color);
            ...
            this.troopTitle.FactionName2Background = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\FactionPicture\" + node.Attributes.GetNamedItem("Background").Value);
            node = nextSibling.ChildNodes.Item(57);
            this.troopTitle.FactionColor2Position = StaticMethods.LoadRectangleFromXMLNode(node);
            this.troopTitle.FactionColor2Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\FactionPicture\" + node.Attributes.GetNamedItem("ColorPicture").Value);
            this.troopTitle.FactionColor2Background = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\FactionPicture\" + node.Attributes.GetNamedItem("ColorBackground").Value);
            node = nextSibling.ChildNodes.Item(61);
            rectangle = StaticMethods.LoadRectangleFromXMLNode(node);
            StaticMethods.LoadFontAndColorFromXMLNode(node, out font, out color);
            this.troopTitle.TroopName2Text = new FreeText(this.graphicsDevice, font, color);
            ...
            this.troopTitle.TheTroopKind21Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\TroopKind\" + node.Attributes.GetNamedItem("TroopKind1").Value);
            this.troopTitle.TheTroopKind22Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\TroopKind\" + node.Attributes.GetNamedItem("TroopKind2").Value);
            this.troopTitle.TheTroopKind23Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\TroopKind\" + node.Attributes.GetNamedItem("TroopKind3").Value);
            this.troopTitle.TheTroopKind24Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\TroopKind\" + node.Attributes.GetNamedItem("TroopKind4").Value);
            this.troopTitle.TheTroopKind25Picture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\TroopKind\" + node.Attributes.GetNamedItem("TroopKind5").Value);

            node = nextSibling.ChildNodes.Item(67);
            rectangle = StaticMethods.LoadRectangleFromXMLNode(node);
            StaticMethods.LoadFontAndColorFromXMLNode(node, out font, out color);
            this.troopTitle.Thebingli2Text = new FreeText(this.graphicsDevice, font, color);
            ...
            this.troopTitle.TheActionDone2Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Done").Value);
            this.troopTitle.TheActionUndone2Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Undone").Value);
            this.troopTitle.TheActionAuto2Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Auto").Value);
            this.troopTitle.TheActionAutoDone2Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("AutoDone").Value);
            node = nextSibling.ChildNodes.Item(72);
            this.troopTitle.TheFoodIcon2Position = StaticMethods.LoadRectangleFromXMLNode(node);
            this.troopTitle.TheFoodNormal2Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Normal").Value);
            this.troopTitle.TheFoodShortage2Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Shortage").Value);
            node = nextSibling.ChildNodes.Item(73);
            this.troopTitle.TheNoControl2Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("NoControl").Value);
            this.troopTitle.TheNoControlIcon2Position = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(74);
            this.troopTitle.TheStunt2Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("Stunt").Value);
            this.troopTitle.TheStuntIcon2Position = StaticMethods.LoadRectangleFromXMLNode(node);

            node = nextSibling.ChildNodes.Item(76);
            this.troopTitle.Theshiqi2Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("FileName").Value);
            this.troopTitle.Theshiqi2Position = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(77);
            this.troopTitle.Thezhanyi2Texture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\TroopTitle\Data\Icon\" + node.Attributes.GetNamedItem("FileName").Value);
