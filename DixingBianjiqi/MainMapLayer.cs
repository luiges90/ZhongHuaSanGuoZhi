            ...
            if (spriteBatch != null)
            {
                    ...
                    */
                    ...
                    if (GlobalVariables.ShowGrid)
                    {
                        foreach (Tile tile in this.DisplayingTiles)
                        {
                            ...
                            {
                                spriteBatch.Draw(this.screen.Textures.xuanzetupian, tile.Destination, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.81f);
                            }
                        }
                    }
                ...
                else
                {
                    ...
                    foreach (Tile tile in this.DisplayingTiles)
                    {
                        ...
                        if (GlobalVariables.ShowGrid)
                        {
                            spriteBatch.Draw(this.screen.Textures.xuanzetupian, tile.Destination, sourceRectangle, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.8999f);
                        }
                        /*
                        if (decorativeTextures != null)
                        {
