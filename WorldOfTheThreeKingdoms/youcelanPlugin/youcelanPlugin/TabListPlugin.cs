namespace youcelanPlugin
{
    ...
    public class TabListPlugin : GameObject, Iyoucelan, IBasePlugin, IPluginXML, IPluginGraphics
    {
        ...
        public void LoadDataFromXMLDocument(string filename)
        {
            ...
            this.tabList.TopLeftTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\youcelan\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(20);
            //this.gameFrame.TopRightWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.TopRightTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\youcelan\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(21);
            //this.gameFrame.BottomLeftWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.BottomLeftTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\youcelan\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(22);
            //this.gameFrame.BottomRightWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.BottomRightTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\youcelan\Data\" + node.Attributes.GetNamedItem("FileName").Value);
