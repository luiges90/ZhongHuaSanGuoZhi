namespace BianduiLiebiaoChajian
{
    ...
    public class Tab
    {
        ...
        public int ID;
        //private TabListPlugin.ListKind listKind;
        private BianduiLiebiaoChajian.ListKind listKind;
        ...
        internal Tab(TabListInFrame tabList, BianduiLiebiaoChajian.ListKind listKind)
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (this.selected)
            {
                ...
                //this.Text.Text = "兵役："+this.Bingyi.ToString();
