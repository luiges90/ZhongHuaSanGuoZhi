...
namespace WorldOfTheThreeKingdoms.GameScreens
{
    partial class MainGameScreen : Screen
    {
        ...
        public override void PersonDeath(Person person, Person killerInBattle, Architecture location, Troop troopLocation)
        {
            ...
            personFaction = person.BelongedFaction == null ? "" : person.BelongedFaction.Name + "?��";
            killerFaction = killerInBattle.BelongedFaction == null ? "" : killerInBattle.BelongedFaction.Name + "?��";
            if (location != null)
            {
        ...
        {
            String personFaction = person.BelongedFaction == null ? "" : person.BelongedFaction.Name + "?��";
