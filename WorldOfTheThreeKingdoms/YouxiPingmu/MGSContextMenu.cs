        ...
        private void HandleContextMenuResult(ContextMenuResult result)
        {
            ...
            switch (result)
            {
                ...
                case ContextMenuResult.Monarch_Diplomatic_ResetDiplomaticRelation:
                    this.ShowTabListInFrame(UndoneWorkKind.Frame, FrameKind.DiplomaticRelation, FrameFunction.GetFriendlyDiplomaticRelation, false, true, true, false, this.CurrentArchitecture.GetResetDiplomaticRelationList(), null, "断交", "");
                    break;
