...
namespace TroopDetailPlugin
{
	...
	{
		private const string Path = "GameComponents\\TroopDetail\\";

		private const string DataPath = "GameComponents\\TroopDetail\\Data\\";
		...
		public void SetGraphicsDevice(GraphicsDevice device)
		{
			...
			this.LoadDataFromXMLDocument("GameComponents\\TroopDetail\\TroopDetailData.xml");
		}
