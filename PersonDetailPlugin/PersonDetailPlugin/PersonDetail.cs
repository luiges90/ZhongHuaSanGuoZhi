                ...
                try
                {
                    if (Switch1 == "on")//新界面打开
                    {
                        ...
                        if (InformationButton == true)
                        {
                            ...
                            {
                                spriteBatch.Draw(this.ImportantTreasureButtonTexture, this.ImportantTreasureButtonClientDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                spriteBatch.Draw(this.ImportantTreasurePressedTexture, this.ImportantTreasurePressedClientDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                            }
                            if (Switch121 == "on" && BiographyButton == false)//人物亲人
                            {
                                spriteBatch.Draw(this.RelativeButtonTexture, this.RelativeButtonDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                spriteBatch.Draw(this.RelativePressedTexture, this.RelativeButtonPressedDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                            }
                            if (Switch122 == "on" && BiographyButton == false)//人物兄弟喜恶
                            {
                                spriteBatch.Draw(this.RelationButtonTexture, this.RelationButtonDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                spriteBatch.Draw(this.RelationPressedTexture, this.RelationButtonPressedDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                            }
                            if (Switch123 == "on" && RelationButton == true)//人物关系
                            {
                                spriteBatch.Draw(this.PersonRelationButtonTexture, this.PersonRelationButtonDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                spriteBatch.Draw(this.PersonRelationPressedTexture, this.PersonRelationButtonPressedDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                            }
                            if (Switch124 == "on" && BiographyButton == false)//在人物详情页显示人物战绩
                            {
                                spriteBatch.Draw(this.StandingsButtonTexture, this.StandingsButtonDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                spriteBatch.Draw(this.StandingsPressedTexture, this.StandingsButtonPressedDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                            }
                            if (Switch21 == "on")//在人物列传
                            {
                                spriteBatch.Draw(this.BiographyButtonTexture, this.BiographyButtonDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                spriteBatch.Draw(this.BiographyPressedTexture, this.BiographyButtonPressedDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                            }

                            spriteBatch.Draw(this.InformationBackgroundTexture, this.InformationBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.185f);
                            spriteBatch.Draw(this.InformationMask2Texture, this.InformationBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1849f);                      
                            ...
                            {
                                spriteBatch.Draw(this.FactionColour, this.FactionColourDisplayPosition, null, this.TheFactionColor, 0f, Vector2.Zero, SpriteEffects.None, 0.1845f);
                                spriteBatch.Draw(this.FactionColourBackground, this.FactionColourDisplayPosition, null, this.TheFactionColor, 0f, Vector2.Zero, SpriteEffects.None, 0.1846f);
                            }
                            if (Switch105 == "on")//势力名称
                            {
                                this.FactionNameText.Draw(spriteBatch, 0.1843f);
                            }
                            if (BiographyButton == false)
                            {
                                spriteBatch.Draw(this.DetailBackgroundTexture, this.TitleBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1844f);
                                spriteBatch.Draw(this.DetailMask2Texture, this.TitleBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18435f);
                                foreach (LabelText text in this.PersonInInformationTexts)
                                {
                                    text.Label.Draw(spriteBatch, 0.1843f);
                                    text.Text.Draw(spriteBatch, 0.1843f);
                                }
                                spriteBatch.Draw(this.DetailMask1Texture, this.TitleBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1842f);
                            }
                            this.ThePersonSkillTexts.Draw(spriteBatch, (float)0.18271f);
                            this.TheLearnableSkillTexts.Draw(spriteBatch, (float)0.18273f);
                            this.TheAllSkillTexts.Draw(spriteBatch, (float)0.18275f);
                            if (Switch132 == "on")//技能背景图片
                            {
                                foreach (Skill skill in this.screen.Scenario.GameCommonData.AllSkills.Skills.Values)
                                {
                                    ...
                                    spriteBatch.Draw(this.AllSkillTextBackground, skillposition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18285f);
                                    if (ShowingPerson.Skills.GetSkill(skill.ID) != null)
                                    {
                                        spriteBatch.Draw(this.PersonSkillTextBackground, skillposition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18281f);
                                    }
                                    else if (skill.CanLearn(ShowingPerson))
                                    {
                                        spriteBatch.Draw(this.LearnableSkillTextBackground, skillposition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18283f);
                                    }
                                }
                            }
                            this.TheInfluenceText.Draw(spriteBatch, 0.1813f);
                            this.TheConditionText.Draw(spriteBatch, 0.1813f);
                            if (Switch131 == "on")//条件与影响背景图片
                            {
                                spriteBatch.Draw(this.ConditionBackground, this.ConditionBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1815f);
                                spriteBatch.Draw(this.InfluenceBackground, this.InfluenceBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1815f);
                            }

                            spriteBatch.Draw(this.InformationMask1Texture, this.InformationBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.183f);
                                                    
                            if (Switch117 == "on" && BiographyButton == false) //重要称号显示
                            {
                                spriteBatch.Draw(this.TitleBackgroundTexture, this.TitleBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1825f);
                                spriteBatch.Draw(this.TitleMask2Texture, this.TitleBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18249f);                      
                            
                                try
                                {
                                    spriteBatch.Draw(this.ImportantTitleTextBackground, this.ImportantTitleTextBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.182f);
                                    this.ImportantTitleText.Draw(spriteBatch, 0.1813f);
                                    ...
                                    if (ShowImportantTitlePicture == "on")
                                    {
                                        for (int t = 1; t <= MaxImportantTitleShowNumber; t++)
                                        {
                                            ...
                                            {
                                                spriteBatch.Draw(this.TheImportantTitlePicture(t), this.TheImportantTitlePictureDisplayPosition(t), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18247f);
                                            }
                                        }
                                    }
                                    if (ShowImportantTitleNameBackground == "on")
                                    {
                                        for (int t = 1; t <= MaxImportantTitleShowNumber; t++)
                                        {
                                            if (HasTheImportantTitle(t) == true)
                                            {
                                                spriteBatch.Draw(this.TheImportantTitleBackground(t), this.TheImportantTitleDisplayPosition(t), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18245f);
                                            }
                                        }
                                    }
                                    if (ShowImportantTitleName == "on")
                                    {
                                        if (HasTheImportantTitle(1) == true && MaxImportantTitleShowNumber > 0) { this.ImportantTitle1NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(2) == true && MaxImportantTitleShowNumber > 1) { this.ImportantTitle2NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(3) == true && MaxImportantTitleShowNumber > 2) { this.ImportantTitle3NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(4) == true && MaxImportantTitleShowNumber > 3) { this.ImportantTitle4NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(5) == true && MaxImportantTitleShowNumber > 4) { this.ImportantTitle5NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(6) == true && MaxImportantTitleShowNumber > 5) { this.ImportantTitle6NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(7) == true && MaxImportantTitleShowNumber > 6) { this.ImportantTitle7NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(8) == true && MaxImportantTitleShowNumber > 7) { this.ImportantTitle8NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(9) == true && MaxImportantTitleShowNumber > 8) { this.ImportantTitle9NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(10) == true && MaxImportantTitleShowNumber > 9) { this.ImportantTitle10NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(11) == true && MaxImportantTitleShowNumber > 10) { this.ImportantTitle11NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(12) == true && MaxImportantTitleShowNumber > 11) { this.ImportantTitle12NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(13) == true && MaxImportantTitleShowNumber > 12) { this.ImportantTitle13NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(14) == true && MaxImportantTitleShowNumber > 13) { this.ImportantTitle14NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(15) == true && MaxImportantTitleShowNumber > 14) { this.ImportantTitle15NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(16) == true && MaxImportantTitleShowNumber > 15) { this.ImportantTitle16NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(17) == true && MaxImportantTitleShowNumber > 16) { this.ImportantTitle17NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(18) == true && MaxImportantTitleShowNumber > 17) { this.ImportantTitle18NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(19) == true && MaxImportantTitleShowNumber > 18) { this.ImportantTitle19NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantTitle(20) == true && MaxImportantTitleShowNumber > 19) { this.ImportantTitle20NameText.Draw(spriteBatch, 0.18243f); }
                                    }
                                }
                                catch { }
                                spriteBatch.Draw(this.TitleMask1Texture, this.TitleBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1823f);                      
                            
                            }
                            if (Switch118 == "on" && BiographyButton == false)//重要特技显示
                            {
                                spriteBatch.Draw(this.StuntBackgroundTexture, this.StuntBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1825f);
                                spriteBatch.Draw(this.StuntMask2Texture, this.StuntBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18249f);                      
                            
                                try
                                {
                                    spriteBatch.Draw(this.ImportantStuntTextBackground, this.ImportantStuntTextBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.182f);
                                    ...
                                    if (ShowImportantStuntPicture == "on")
                                    {
                                        for (int t = 1; t <= MaxImportantStuntShowNumber; t++)
                                        {
                                            ...
                                            {
                                                spriteBatch.Draw(this.TheImportantStuntPicture(t), this.TheImportantStuntPictureDisplayPosition(t), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18247f);
                                            }
                                        }
                                    }
                                    if (ShowImportantStuntNameBackground == "on")
                                    {
                                        for (int t = 1; t <= MaxImportantStuntShowNumber; t++)
                                        {
                                            if (HasTheImportantStunt(t) == true)
                                            {
                                                spriteBatch.Draw(this.TheImportantStuntBackground(t), this.TheImportantStuntDisplayPosition(t), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18245f);
                                            }
                                        }
                                    }
                                    if (ShowImportantStuntName == "on")
                                    {
                                        if (HasTheImportantStunt(1) == true && MaxImportantStuntShowNumber> 0) { this.ImportantStunt1NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(2) == true && MaxImportantStuntShowNumber > 1) { this.ImportantStunt2NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(3) == true && MaxImportantStuntShowNumber > 2) { this.ImportantStunt3NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(4) == true && MaxImportantStuntShowNumber > 3) { this.ImportantStunt4NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(5) == true && MaxImportantStuntShowNumber > 4) { this.ImportantStunt5NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(6) == true && MaxImportantStuntShowNumber > 5) { this.ImportantStunt6NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(7) == true && MaxImportantStuntShowNumber > 6) { this.ImportantStunt7NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(8) == true && MaxImportantStuntShowNumber > 7) { this.ImportantStunt8NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(9) == true && MaxImportantStuntShowNumber > 8) { this.ImportantStunt9NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(10) == true && MaxImportantStuntShowNumber > 9) { this.ImportantStunt10NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(11) == true && MaxImportantStuntShowNumber > 10) { this.ImportantStunt11NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(12) == true && MaxImportantStuntShowNumber > 11) { this.ImportantStunt12NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(13) == true && MaxImportantStuntShowNumber > 12) { this.ImportantStunt13NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(14) == true && MaxImportantStuntShowNumber > 13) { this.ImportantStunt14NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(15) == true && MaxImportantStuntShowNumber > 14) { this.ImportantStunt15NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(16) == true && MaxImportantStuntShowNumber > 15) { this.ImportantStunt16NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(17) == true && MaxImportantStuntShowNumber > 16) { this.ImportantStunt17NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(18) == true && MaxImportantStuntShowNumber > 17) { this.ImportantStunt18NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(19) == true && MaxImportantStuntShowNumber > 18) { this.ImportantStunt19NameText.Draw(spriteBatch, 0.18243f); }
                                        if (HasTheImportantStunt(20) == true && MaxImportantStuntShowNumber > 19) { this.ImportantStunt20NameText.Draw(spriteBatch, 0.18243f); }
                                    }
                                }
                                catch { }
                                spriteBatch.Draw(this.StuntMask1Texture, this.StuntBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1823f);                      
                            
                            }
                            if (ImportantTreasureButton == true)
                            {
                                spriteBatch.Draw(this.TreasureBackgroundTexture, this.StuntBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1825f);
                                spriteBatch.Draw(this.TreasureMask2Texture, this.StuntBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18249f);                      
                            
                                if (Switch114 == "on")//重要宝物显示
                                {                                    
                                    spriteBatch.Draw(this.ImportantTreasureBackground, this.ImportantTreasureBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18247f);
                                    try
                                    {
                                        if (Switch116 == "on")
                                        {
                                            ...
                                            {
                                                spriteBatch.Draw(this.SexPicture, this.ThePersonPictureInTreasureDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18246f);
                                            }
                                        ...
                                        for (int t = 1; t <= MaxImportantTreasureShowNumber; t++)
                                        {
                                            ...
                                            {
                                                spriteBatch.Draw(this.TheImportantTreasurePicture(t), this.TheImportantTreasureDisplayPosition(t), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18245f);
                                                spriteBatch.Draw(this.ImportantTreasureShowMask, this.TheImportantTreasureDisplayPosition(t), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18244f);
                                            }
                                        }
                                    }
                                    catch { }
                                    spriteBatch.Draw(this.ImportantTreasureMask, this.ImportantTreasureBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18243f);
                                }
                                if (Switch115 == "on")
                                {                                                                      
                                    spriteBatch.Draw(this.GeneralTreasureBackground, this.GeneralTreasureBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18247f);
                                    try
                                    {
                                        for (int i = 0; i < MaxGeneralTreasureShowNumber; i++)
                                        {                                            
                                            spriteBatch.Draw(this.TheGeneralTreasurePicture(i), this.TheGeneralTreasureDisplayPosition(i), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18245f);
                                            spriteBatch.Draw(this.GeneralTreasureShowMask, this.TheGeneralTreasureDisplayPosition(i), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18244f);
                                            if (ShowNullTreasurePicture == "on")
                                            {
                                                spriteBatch.Draw(this.GeneralTreasureShowBackground, this.GeneralTreasureDisplayPosition(i), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18246f);
                                            }
                                        }
                                    }
                                    catch { }
                                    spriteBatch.Draw(this.GeneralTreasureMask, this.GeneralTreasureBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18243f); 
                                }
                                spriteBatch.Draw(this.TreasureMask1Texture, this.StuntBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1823f);
                                try
                                {
                                    spriteBatch.Draw(this.ImportantTreasureTextPicture, this.ImportantTreasureTextPictureDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1815f);
                                    spriteBatch.Draw(this.ImportantTreasureTextBackground, this.ImportantTreasureTextBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.182f);
                                    spriteBatch.Draw(this.ImportantTreasureTextMask, this.ImportantTreasureTextBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.181f);
                        ...
                        {
                            spriteBatch.Draw(this.RelativeMask, this.RelativeBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1823f);
                            spriteBatch.Draw(this.RelativeBackground, this.RelativeBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1825f);
                            this.GenerationText.Draw(spriteBatch, 0.18243f);
                            this.StrainText.Draw(spriteBatch, 0.18243f);
                            ...
                            this.SpouseNameText.Draw(spriteBatch, 0.18243f);
                            this.ChildrenNumberText.Draw(spriteBatch, 0.18243f);
                            if (ChildrenN > 0)
                            {
                                this.ChildrenText.Draw(spriteBatch, 0.18243f);
                            }
                        }
                        if (RelationButton == true)//人物兄弟喜恶
                        {
                            spriteBatch.Draw(this.RelationMask, this.RelationBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1823f);
                            spriteBatch.Draw(this.RelationBackground, this.RelationBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1825f);
                            this.BrothersText.Draw(spriteBatch, 0.18243f);
                            this.ClosePersonsText.Draw(spriteBatch, 0.18243f);
                            this.HatedPersonsText.Draw(spriteBatch, 0.18243f);
                        }

                        if (PersonRelationButton == true)//人物关系
                        {
                            spriteBatch.Draw(this.PersonRelationMask, this.PersonRelationBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1823f);
                            spriteBatch.Draw(this.PersonRelationBackground, this.PersonRelationBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1825f);
                        ...
                        {
                            spriteBatch.Draw(this.StandingsMask, this.StandingsBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1823f);
                            spriteBatch.Draw(this.StandingsBackground, this.StandingsBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1825f);
                            foreach (LabelText text in this.StandingsTexts)
                            {
                                text.Label.Draw(spriteBatch, 0.18243f);
                                text.Text.Draw(spriteBatch, 0.18243f);
                            }
                        }
                        /////////
                        if (BiographyButton == true)//↓人物列传
                        {
                            spriteBatch.Draw(this.BiographyBackgroundTexture, this.BiographyBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1825f);
                            spriteBatch.Draw(this.BiographyMask2Texture, this.BiographyBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18249f);
                            
                            if (Switch24 == "on")//在人物列传分页
                            {
                                if (Switch26 == "on")//列传
                                {
                                    spriteBatch.Draw(this.BiographyBriefButtonTexture, this.BiographyBriefButtonDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                    spriteBatch.Draw(this.BiographyBriefPressedTexture, this.BiographyBriefButtonPressedDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                }
                                if (Switch27 == "on")//演义
                                {
                                    spriteBatch.Draw(this.BiographyRomanceButtonTexture, this.BiographyRomanceButtonDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                    spriteBatch.Draw(this.BiographyRomancePressedTexture, this.BiographyRomanceButtonPressedDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                }
                                if (Switch28 == "on")//历史
                                {
                                    spriteBatch.Draw(this.BiographyHistoryButtonTexture, this.BiographyHistoryButtonDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                    spriteBatch.Draw(this.BiographyHistoryPressedTexture, this.BiographyHistoryButtonPressedDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                }
                                if (Switch29 == "on")//剧本
                                {
                                    spriteBatch.Draw(this.BiographyInGameButtonTexture, this.BiographyInGameButtonDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                    spriteBatch.Draw(this.BiographyInGamePressedTexture, this.BiographyInGameButtonPressedDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1821f);
                                }
                                this.PersonBiographyText.Draw(spriteBatch, 0.18235f);
                            }
                            else
                            {
                                this.PersonBiographyText.Draw(spriteBatch, 0.18235f);
                            ...
                            {
                                spriteBatch.Draw(this.TitleTextBackground, this.TitleTextBackgroundDisplayPosition, this.TitleCountDisplayPosition, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18245f);
                            }
                            this.TheTitleText.Draw(spriteBatch, 0.18243f);
                            if (Switch134 == "on")//称号背景图片
                            {
                                spriteBatch.Draw(this.StuntTextBackground, this.StuntTextBackgroundDisplayPosition, this.StuntCountDisplayPosition, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.18245f);
                            }                            
                            this.TheStuntText.Draw(spriteBatch, 0.18243f);
                            spriteBatch.Draw(this.BiographyMask1Texture, this.BiographyBackgroundDisplayPosition, null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.1823f);
                    ...
                    if (Switch1 == "off")//旧界面
                    {
                        try
                        {
                            ...
                            spriteBatch.Draw(this.BackgroundMask2, this.BackgroundDisplayPosition, sourceRectangle, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.189f);
                            ...
                            spriteBatch.Draw(this.BackgroundMask1, this.BackgroundDisplayPosition, sourceRectangle, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.183f);
                        }
                        catch { }
                        foreach (LabelText text in this.LabelTexts)
                        {
                            text.Label.Draw(spriteBatch, 0.184f);
                            text.Text.Draw(spriteBatch, 0.184f);
                        }
                        this.TitleText.Draw(spriteBatch, 0.184f);
                        //this.GuanzhiText.Draw(spriteBatch, 0.184f);
                        this.AllSkillTexts.Draw(spriteBatch, (float)0.1837f);
                        this.PersonSkillTexts.Draw(spriteBatch, (float)0.1833f);
                        this.LearnableSkillTexts.Draw(spriteBatch, (float)0.1835f);
                        this.StuntText.Draw(spriteBatch, 0.184f);
                        this.InfluenceText.Draw(spriteBatch, 0.1831f);
                        this.ConditionText.Draw(spriteBatch, 0.1831f);
                        this.BiographyText.Draw(spriteBatch, 0.184f);
                        this.PersonTreasuresText.Draw(spriteBatch, 0.184f);//宝物显示
                    }
                }
                catch { }
                this.SurNameText.Draw(spriteBatch, 0.1827f);
                this.GivenNameText.Draw(spriteBatch, 0.1827f);
                this.CalledNameText.Draw(spriteBatch, 0.1827f);               
            }
        }
        ...
        private void screen_OnMouseLeftDown(Point position)
        {
            ...
            if (Switch1 == "on")
            {
                ...
                if (ImportantTreasure == false && BiographyButton == false && StaticMethods.PointInRectangle(position, this.ImportantTreasureButtonClientDisplayPosition))
                {
                    if (Switch3 == "on")
                    {
                        this.screen.PlayNormalSound("GameComponents/PersonDetail/Data/Sound/Select/Open.wav");
                    }
                ...
                if (ImportantTreasure == true && BiographyButton == false && StaticMethods.PointInRectangle(position, this.ImportantTreasurePressedClientDisplayPosition))
                {
                    if (Switch3 == "on")
                    {
                        this.screen.PlayNormalSound("GameComponents/PersonDetail/Data/Sound/Select/Close.wav");
                    }
                ...
                if (BiographyBriefButton == false && BiographyButton == true && StaticMethods.PointInRectangle(position, this.BiographyBriefButtonDisplayPosition))
                {
                    if (Switch3 == "on")
                    {
                        this.screen.PlayNormalSound("GameComponents/PersonDetail/Data/Sound/Select/Select.wav");
                    }
        ...
        internal void SetPerson(Person person)
        {
            ...
            {                
                ...
                */
                ...
                {
                    if (File.Exists(@"GameComponents\PersonDetail\Data\Sound\Person\" + this.IDN.ToString() + ".wav"))
                    { this.ThePersonSound = "GameComponents/PersonDetail/Data/Sound/Person/" + this.IDN.ToString() + ".wav"; }
                    else
                    { this.ThePersonSound = "GameComponents/PersonDetail/Data/Sound/Person/Open.wav"; }
