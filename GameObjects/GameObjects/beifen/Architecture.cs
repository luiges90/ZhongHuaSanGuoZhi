namespace GameObjects
{
    ...
    public class Architecture : GameObject
    {
        ...
        private PersonList agriculturePersons = new PersonList();
            ...
            if (((this.PlanArchitecture == null) || GameObject.Chance(10)) && this.HasPerson())
            {
                ...
                else if ((GameObject.Chance(20) || !this.HasBuildingRouteway) || this.IsFundEnough)
                {
                    ...
                    if (this.Kind.HasPopulation && (flag2 || (this.BelongedFaction.PlanTechniqueArchitecture != this)))
                    {
                        ...
                        else if (((this.Population > this.RecruitmentPopulationBoundary) || flag2) || ((this.Population >= 0x2710) && GameObject.Chance(5)))
                        {
                            bool flag3 = true;
                            foreach (Military military in this.Militaries)
                            {
        ...
        private void OffensiveCampaign()
        {
            ...
            else if ((this.PlanArchitecture != null) || (this.InformationCoolDown <= 0))
            {
                ...
                else if ((((this.PlanArchitecture != null) || (this.Population < (0x2710 * this.AreaCount))) || ((this.Domination >= this.DominationCeiling) || (this.Endurance >= (this.EnduranceCeiling * 0.2f)))) || GameObject.Chance(5))
                {
                        ...
                        else
                        {
                            ...
                            foreach (LinkNode node2 in this.AIAllLinkNodes.Values)
                            {
                                ...
                                switch (this.BelongedFaction.Leader.StrategyTendency)
                                {
                                    ...
                                    {
                                        if (node2.A.LocationState.LinkedRegion == this.LocationState.LinkedRegion)
                                        {
                                            break;
                                        }
                                        continue;
                                    ...
                                    {
                                        if (node2.A.LocationState == this.LocationState)
                                        {
                                            break;
                                        }
                                        continue;
        ...
        public int AgricultureCeiling
        {
            get
            {
                return ((this.Kind.AgricultureBase + (this.Kind.AgricultureUnit * (this.AreaCount - 1))) + this.IncrementOfAgricultureCeiling);
            }
        }
        ...
        public int CommerceCeiling
        {
            get
            {
                return ((this.Kind.CommerceBase + (this.Kind.CommerceUnit * (this.AreaCount - 1))) + this.IncrementOfCommerceCeiling);
            }
        }
        ...
        public int DominationCeiling
        {
            get
            {
                return (this.Kind.DominationBase + (this.Kind.DominationUnit * (this.AreaCount - 1)));
            }
        }
        ...
        public int EnduranceCeiling
        {
            get
            {
                return ((this.Kind.EnduranceBase + (this.Kind.EnduranceUnit * (this.AreaCount - 1))) + this.IncrementOfEnduranceCeiling);
            }
        }
        ...
        public int FacilityPositionCount
        {
            get
            {
                return (this.Kind.FacilityPositionUnit * (this.AreaCount + this.IncrementOfFacilityPositionCount));
            }
        }
        ...
        public int FoodCeiling
        {
            get
            {
                return (this.kind.FoodMaxUnit * this.AreaCount);
            }
        }
        ...
        public int FundCeiling
        {
            get
            {
                return (this.Kind.FundMaxUnit * this.AreaCount);
            }
        }
        ...
        public int MoraleCeiling
        {
            get
            {
                return (this.Kind.MoraleBase + (this.Kind.MoraleUnit * (this.AreaCount - 1)));
            }
        }
        ...
        public int PopulationCeiling
        {
            get
            {
                return (this.Kind.PopulationBase + (this.Kind.PopulationUnit * (this.AreaCount - 1)));
            }
        }
        ...
        public int TechnologyCeiling
        {
            get
            {
                return ((this.Kind.TechnologyBase + (this.Kind.TechnologyUnit * (this.AreaCount - 1))) + this.IncrementOfTechnologyCeiling);
            }
        }
