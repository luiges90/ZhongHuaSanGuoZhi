namespace GameObjects
{
    ...
    public class Architecture : GameObject
    {
        ...
        private void zainanshijian()
        {
            ...
            else
            {
                if (GameObject.Random(3000)==0 && base.Scenario.IsPlayer(this.BelongedFaction) && this.Kind.ID == 1)
                {
                    ...
                    this.Onfashengzainan(this, this.zainan.zainanzhonglei.Name);
                }
            }
        }
        ...
        public int AgricultureCeiling
        {
            get
            {
                return ((this.Kind.AgricultureBase + (this.Kind.AgricultureUnit * (this.Areageshu - 1))) + this.IncrementOfAgricultureCeiling);
            }
        }
        ...
        public int CommerceCeiling
        {
            get
            {
                return ((this.Kind.CommerceBase + (this.Kind.CommerceUnit * (this.Areageshu - 1))) + this.IncrementOfCommerceCeiling);
            }
        }
        ...
        public int DominationCeiling
        {
            get
            {
                return (this.Kind.DominationBase + (this.Kind.DominationUnit * (this.Areageshu - 1)));
            }
        }
        ...
        public int EnduranceCeiling
        {
            get
            {
                return ((this.Kind.EnduranceBase + (this.Kind.EnduranceUnit * (this.Areageshu - 1))) + this.IncrementOfEnduranceCeiling);
            }
        }
        ...
        public int FacilityPositionCount
        {
            get
            {
                return (this.Kind.FacilityPositionUnit * (this.Areageshu + this.IncrementOfFacilityPositionCount));
            }
        }
        ...
        public int FoodCeiling
        {
            get
            {
                return (this.kind.FoodMaxUnit * this.Areageshu);
            }
        }
        ...
        public int FundCeiling
        {
            get
            {
                return (this.Kind.FundMaxUnit * this.Areageshu);
            }
        }
        ...
        public int MoraleCeiling
        {
            get
            {
                return (this.Kind.MoraleBase + (this.Kind.MoraleUnit * (this.Areageshu - 1)));
            }
        }
        ...
        public int PopulationCeiling
        {
            get
            {
                return (this.Kind.PopulationBase + (this.Kind.PopulationUnit * (this.Areageshu - 1)));
            }
        }
        ...
        public int TechnologyCeiling
        {
            get
            {
                return ((this.Kind.TechnologyBase + (this.Kind.TechnologyUnit * (this.Areageshu - 1))) + this.IncrementOfTechnologyCeiling);
            }
        }
        ...
        {
            if (this.feiziliebiao.Count != 0 && this.Persons.GameObjects.Contains(this.BelongedFaction.Leader))
            {
        ...
        public delegate void fashengzainan(Architecture architecture, string  zainanming);
