namespace GameObjects
{
    ...
    public class Screen : DrawableGameComponent
    {
        ...
        public virtual void EarlyMouseLeftDown()
        {
            ...
            {
                this.OnMouseLeftDown(new Point(this.mouseState.X, this.mouseState.Y));
            }
        }
        ...
        public virtual void EarlyMouseLeftUp()
        {
            ...
            {
                this.OnMouseLeftUp(new Point(this.mouseState.X, this.mouseState.Y));
            }
        }
        ...
        {
            this.EnableScroll = this.IsPositionEnable(this.ScrollDisableRects, new Point(this.mouseState.X, this.mouseState.Y));
            this.EnableLaterMouseEvent = this.IsPositionEnable(this.LaterMouseEventDisableRects, new Point(this.mouseState.X, this.mouseState.Y));
            this.EnableSelecting = this.IsPositionEnable(this.SelectingDisableRects, new Point(this.mouseState.X, this.mouseState.Y));
        }
        ...
        public Point RealViewportSize
        {
            get
            {
                return new Point(base.Game.GraphicsDevice.Viewport.X, base.Game.GraphicsDevice.Viewport.Y);
            }
        }
